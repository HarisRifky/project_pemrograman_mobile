...
import 'package:myapp/app/modules/interior3ke2/views/interior3ke2_view.dart'; // Import for using GetX

class Interior3View extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.asset(
                'assets/interior3.png', // Ensure this image is in the assets folder
                height: 180.0,
            ...
            Row(
              ...
              children: [
                buildCustomButton('Kursi', false, () {
                  Get.to(() => Interior3ke2View()); // Navigate to Interior3ke2View
                }),
