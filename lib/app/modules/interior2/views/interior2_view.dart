...
import 'package:myapp/app/modules/interior2ke2/views/interior2ke2_view.dart';

class Interior2View extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.asset(
                'assets/interior2.png', // Ensure this image is in the assets folder
                height: 180.0,
            ...
            Row(
              ...
              children: [
                buildCustomButton('Kursi', false, () {
                  Get.to(() => Interior2ke2View()); // Navigate to Interior2ke2View
                }),
