...
import 'package:myapp/app/modules/interior1ke2/views/interior1ke2_view.dart';

class Interior1View extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.asset(
                'assets/interior1.png', // Make sure this image is in the assets folder
                height: 180.0,
