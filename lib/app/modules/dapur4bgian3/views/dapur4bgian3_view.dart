...
import 'package:myapp/app/modules/Dapursukses/views/dapursukses_view.dart';

class Dapur4bgian3View extends StatelessWidget {
  @override
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('assets/dapur4.jpg'),
                          fit: BoxFit.cover,
                        ),
              ...
              child: Align(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF562B08), // Menggunakan warna accent yang sama
  ...
  Widget _buildCustomChip(String label, {required bool isSelected}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected ? Color(0xFF562B08) : Color(0xFFDDDDDD), // Menggunakan warna yang sama
        borderRadius: BorderRadius.circular(20),
      ),
      child: Text(
        label,
