...
class Dapur2bgian3View extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFFFFFFF0), // Diubah ke warna yang sama dengan Interior1ke3View
      body: SafeArea(
        child: Column(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('assets/dapur2.jpg'),
                          fit: BoxFit.cover,
                        ),
              ...
              child: Align(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    'Order Now',
                    style: TextStyle(
                      color: Colors.white, // Diubah ke warna putih untuk kontras yang lebih baik
                      fontWeight: FontWeight.bold,
                    ),
                  ),
